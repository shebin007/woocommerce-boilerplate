...
function boilerplate_scripts() {
	wp_enqueue_style( 'boilerplate-style', get_stylesheet_uri(), array(), BOILERPLATE_VERSION );
	wp_enqueue_script( 'boilerplate-script', get_template_directory_uri() . '/js/script.min.js', array(), BOILERPLATE_VERSION, true );
 ...
 * @return array
 */
function boilerplate_tinymce_add_class( $settings ) {
	$settings['body_class'] = 'block-editor-block-list__layout';
	return $settings;
}
add_filter( 'tiny_mce_before_init', 'boilerplate_tinymce_add_class' );
