 ...
 * Slug: boiler-plate/post-header-featured-image
 * Categories: featured
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:post-title {"textColor":"white","className":"is-style-boiler-plate-text-shadow","fontSize":"x-large"} /-->
